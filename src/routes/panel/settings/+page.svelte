...
<PanelPageWrapper title="Settings" description="Manage your account settings and preferences.">
	...
	<div class="space-y-6">
		...
		<Card>
			...
			<p class="mt-1 text-sm text-gray-600">Manage your account preferences and security settings.</p>
			...
			<div class="mt-6 space-y-6">
				...
				<div class="flex items-center justify-between">
					<div>
						...
						<p class="text-sm text-gray-600">Receive notifications when you log in.</p>
					</div>
					<Button variant="secondary" size="sm">Enable</Button>
				</div>
		...
		<Card>
			<h2 class="text-lg font-bold text-gray-800">Notification Preferences</h2>
			<p class="mt-1 text-sm text-gray-600">Choose how you want to be notified about activities.</p>
			...
			<div class="mt-6 space-y-4">
				...
				<div class="flex items-start">
					...
					<div class="ml-3">
						...
						<p class="text-sm text-gray-600">Receive text messages for urgent notifications.</p>
					</div>
				</div>
			</div>
		</Card>
		...
		<Card className="border-l-4 border-red-500">
			...
			<div class="mt-6">
				<Button variant="secondary" className="border-red-200 text-red-700 hover:border-red-300 hover:bg-red-50">
					Delete Account
				</Button>
				<p class="mt-2 text-sm text-gray-600">This action cannot be undone. All your data will be permanently removed.</p>
			</div>
		</Card>
	</div>
</PanelPageWrapper>