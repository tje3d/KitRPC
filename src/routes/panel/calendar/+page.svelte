		...
		<Card variant="flat" className="lg:col-span-3">
			...
			<div class="mt-6 grid grid-cols-7 gap-1">
				...
				{#each calendarDays as day, i}
					...
					{:else}
						<div
							class={`h-24 border border-gray-100 p-1 ${day === today.getDate() ? 'bg-blue-50' : 'hover:bg-gray-50'}`}
						>
							<div
								class={`text-right text-sm ${day === today.getDate() ? 'font-bold text-blue-600' : 'text-gray-900'}`}
							>
								{day}
							</div>
							<!-- Events for this day -->
